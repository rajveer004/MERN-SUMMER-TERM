...
const passedStudents = updatedStudentData.filter(student => {
    return student.resultStatus === "Pass";
});
...
const failedStudents = updatedStudentData.filter(student => {
    return student.resultStatus === "Fail";
});
